...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.r1);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.r1);
        }
        ...
        //</div>
        //<p class="msonormal">&nbsp;<a href="/android_asset/HTML/r2/r2.htm">&gt;&gt;&gt; В НАЧАЛО  &gt;&gt;&gt;</a></p>
        //</body>
        //</html>
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.r1) {
            webView.loadUrl(resourceDir + "r1/r1.htm");
        } else if (id == R.id.r2) {
            webView.loadUrl(resourceDir + "r2/r2.htm");
        } else if (id == R.id.r3) {
            webView.loadUrl(resourceDir + "r3/r3.htm");
        } else if (id == R.id.r4) {
            webView.loadUrl(resourceDir + "r4/r4.htm");
        } else if (id == R.id.needed) {
            webView.loadUrl(resourceDir + "religion-need/yes/needed.htm");
        } else if (id == R.id.no_need) {
            webView.loadUrl(resourceDir + "religion-need/no/no_need.htm");

            // Блок внешних переходов
        } else {
            if (id == R.id.main_religions) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.main_religions));
            }
            if (id == R.id.history) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.history));
            }
            if (id == R.id.opinion) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.opinion));
            }
